...
<body data-ng-cloak>
    ...
    <header class="navbar navbar-inner navbar-fixed-top" data-ng-controller="NavbarController as vm">
        <nav class="container">
            ...
            <div class="nav-container" data-collapse="isCollapsed">
                ...
                <!--
                <ul class="nav navbar-nav nav-pills navBarPadding">
                    <li data-ng-class="{'active':vm.highlight('/customers')}"><a href="#/customers">Customers</a></li>
                    <li data-ng-class="{'active':vm.highlight('/orders')}"><a href="#/orders">Orders</a></li>
                    <li data-ng-class="{'active':vm.highlight('/about')}"><a href="#/about">About</a></li>
                    <li data-ng-class="{'active':vm.highlight('/login')}" id="nav-login"
